Locales['fr'] = {
  ['sex'] = 'sexe',
  ['mom'] = 'Visage de la mère 21-41 et 45 sont des femmes',
  ['dad'] = 'Visage du père 0-20 et 42-44 sont des hommes',
  ...
  ['lip_fullness'] = 'Epaisseur des lèvres',
  ['jaw_bone_width'] = 'Largeur de la machoire',
  ['jaw_bone_length'] = 'Longueur de la machoire',
  ['chin_height'] = 'Hauteur du menton',
  ['chin_length'] = 'Longueur du menton',
  ['chin_width'] = 'Largeur du menton',
  ['chin_hole'] = 'Taille de faussette du menton',
  ...
  ['eyebrow_color_1'] = 'Sourcils couleur 1',
  ['eyebrow_color_2'] = 'Sourcils couleur 2',
