Config                            = {}
Config.Locale = 'fr' -- your language, It would be nice if you send me your translation on fivem forum
...
Config.DistanceFromCity = 100000 -- set distance that player cant sell drugs too far from city
