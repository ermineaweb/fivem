Locales['en'] = {
  ...
  ['londonkings_wear'] = 'London Kings Outfit',
  ...
  ['being_searched'] = 'You Are Being ~y~Searched~s~ By The ~b~London Kings~s~',
  -- Vehicle interaction
