Locales['en'] = {
  ...
  ['being_searched'] = 'You Are Being ~y~Searched~s~ By The ~b~The Firm~s~',
  -- Vehicle interaction
  ...
  -- Notifications
  ['alert_thefirm'] = 'The Firm Alert',
  ['phone_thefirm'] = 'The Firm',
}
